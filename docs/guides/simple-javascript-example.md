...
Here's a basic example of how to use Type Route with Javascript. Click the **Run** button to try it out on CodeSandbox. Other guides cover more complex use cases.
